        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-gray-500 text-sm leading-6">
              Building a sustainable future through environmental conservation, education, and community engagement.
            </p>
          </div>
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                ...
                <ul role="list" className="mt-6 space-y-4">
                  <li>
                    <a href="mailto:info@evergreenfutures.org" className="text-sm leading-6 text-gray-600 hover:text-primary-600">
                      info@evergreenfutures.org
                    </a>
                  </li>
                  <li>
                    <a href="tel:+1234567890" className="text-sm leading-6 text-gray-600 hover:text-primary-600">
                      (123) 456-7890
                    </a>
                  </li>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
          <div className="flex justify-between items-center">
            <p className="text-xs leading-5 text-gray-500">
              &copy; {new Date().getFullYear()} Evergreen Futures. All rights reserved.
            </p>
