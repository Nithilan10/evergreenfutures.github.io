      ...
      <main className="flex-grow">
            ...
            <div className="mt-20 sm:mt-24 md:mx-auto md:max-w-2xl lg:mx-0 lg:mt-0 lg:w-screen">
              ...
              <div className="shadow-lg md:rounded-3xl">
                <div className="bg-primary-500 [clip-path:inset(0)] md:[clip-path:inset(0_round_theme(borderRadius.3xl))]">
                  <div className="absolute -inset-x-px -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" aria-hidden="true">
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Through our various programs and initiatives, we're working to create a more sustainable and environmentally conscious future.
            </p>
          </div>
        ...
        <div className="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-600">
              Join us in our mission to create a sustainable future. Your support can help us make a real impact.
            </p>
...
const features = [
  {
    ...
    description: 'We work to protect and restore natural habitats, promote biodiversity, and implement sustainable practices in our community.',
  ...
  },
  {
    ...
    description: 'Our educational initiatives help raise awareness about environmental issues and teach sustainable practices to future generations.',
  ...
  },
  {
    ...
    description: 'We believe in the power of community. Join us in our local initiatives and help create a more sustainable future together.',
